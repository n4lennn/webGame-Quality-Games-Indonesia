...
export class GameScene {
  constructor(canvas) {
    ...
    this.diffTimer  = 0;
    this.active     = false;
    this.onGameOver = null; // callback(finalScore, vehicleType)
  }
  ...
  draw() {
    ...
    // Background (grass / sidewalk areas)
  ...
  _drawHUD(ctx, W) {
    ...
    roundRect(ctx, W/2 - 80, 14, 160, 38, 8,
      'rgba(0,0,0,0.5)', null);
    ctx.fillStyle = '#fff';
    ...
    ctx.fillStyle = 'rgba(0,0,0,0.5)';
    roundRect(ctx, barX - 4, barY - 4, barW + 8, 28, 6,
      'rgba(0,0,0,0.5)', null);
    ...
    if (this.difficulty > 0) {
      ...
      roundRect(ctx, W/2 - 40, 58, 80, 20, 4,
        'rgba(231,76,60,0.15)', null);
